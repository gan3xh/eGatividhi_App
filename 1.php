...
#differenceVisualization img {
  ...
  <div class="upload-container">
    ...
    <div class="week-row">
        ...
        <div class="image-slots">
            ...
            <div class="upload-box">
             ...
             <div class="progress-detection-container">
    <h4>Compare Progress</h4>
    <div class="row mb-4">
        <div class="col-md-6">
            <label class="form-label">Select First Image</label>
            <select class="form-control image-select" id="image1Select">
                <option value="">Choose an image...</option>
                <?php foreach ($progress_images as $week): ?>
                    <optgroup label="Week <?php echo $week['week']; ?>">
                        <?php foreach ($week['images'] as $image): ?>
        ...
        <div class="col-md-6">
            <label class="form-label">Select Second Image</label>
            <select class="form-control image-select" id="image2Select">
                <option value="">Choose an image...</option>
                <?php foreach ($progress_images as $week): ?>
                    <optgroup label="Week <?php echo $week['week']; ?>">
                        <?php foreach ($week['images'] as $image): ?>
    ...
    <button id="compareBtn" class="button" disabled>
        <span class="button__text">Compare Progress</span>
    </button>

    <div id="progressResults" style="display: none;">
        <div class="row">
            <div class="col-md-6">
                <h5>Analysis Results</h5>
                <div role="progressbar" aria-valuemin="0" aria-valuemax="100" style="--value:0"></div>
                <div class="mt-3">
                    <p><strong>SSIM Score:</strong> <span id="ssimScore">-</span></p>
                    <p><strong>Change Percentage:</strong> <span id="changePercentage">-</span>%</p>
                    <p><strong>Progress Estimation:</strong> <span id="progressEstimation">-</span>%</p>
                </div>
            </div>
            <div class="col-md-6">
                <h5>Difference Visualization</h5>
                <div id="differenceVisualization">
                    <img id="diffImage" src="" alt="Difference visualization">
                </div>
            </div>
        </div>
    </div>
...
<a href="http://127.0.0.1:5000/" class="botton">Get Started</a>
    ...
    function updateCompareButton() {
        compareBtn.disabled = !image1Select.value || !image2Select.value;
    }
    
    image1Select.addEventListener('change', updateCompareButton);
    image2Select.addEventListener('change', updateCompareButton);
    
    compareBtn.addEventListener('click', function() {
        const formData = new FormData();
        formData.append('compare_images', '1');
        formData.append('image1_id', image1Select.value);
        formData.append('image2_id', image2Select.value);
        ...
        .then(data => {
            ...
            // Update progress bar
            progressBar.style.setProperty('--value', data.progress_estimation);
